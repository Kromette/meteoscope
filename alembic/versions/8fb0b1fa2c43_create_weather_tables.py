...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "longitude BETWEEN -180 AND 180", name="ck_locations_longitude"
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "cloud_cover BETWEEN 0 AND 100", name="ck_weather_observations_cloud_cover"
        ),
        sa.CheckConstraint(
            "precipitation >= 0", name="ck_weather_observations_precipitation"
        ),
        sa.CheckConstraint(
        ...
        sa.CheckConstraint(
            "wind_gusts_10m >= 0", name="ck_weather_observations_wind_gusts"
        ),
        sa.CheckConstraint(
            "wind_speed_10m >= 0", name="ck_weather_observations_wind_speed"
        ),
